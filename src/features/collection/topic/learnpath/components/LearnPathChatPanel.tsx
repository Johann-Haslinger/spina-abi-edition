  ...
  return (
    <ChatMessage
      ...
      bubbleClassName={`rounded-3xl px-4 py-2.5 ${
        isUser
          ? 'max-w-[60%] bg-white/5 text-white shadow-[0_8px_30px_rgba(15,23,42,0.16)]'
          : 'min-w-0 max-w-full bg-transparent text-white shadow-none break-words [overflow-wrap:anywhere] [&_*]:max-w-full'
      }`}
    >
      {isUser ? (
